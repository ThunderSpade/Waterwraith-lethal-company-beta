...
namespace Waterwraith
{
    class WaterwraithAI : EnemyAI
    {
        ...
        public override void OnCollideWithPlayer(Collider other)
        {
            ...
            if (player == null)
            {
                Debug.LogWarning(" collided with a player, but player was null.");
                return;
            }
        ...
        public void RefreshTargetServerRpc()
        {
            ...
            if (Plugin.configShowTarget.Value) gameObject.GetComponentInChildren<ScanNodeProperties>().subText = "Hunting : " + tempPlayer.playerUsername;
        ...
        public void RefreshTargetClientRpc(int playerId) // possibly unecessary
        {
            ...
            if (Plugin.configShowTarget.Value) gameObject.GetComponentInChildren<ScanNodeProperties>().subText = "Hunting : " + player.playerUsername;
        }
        ...
        {
            // Deal 40 damage to the player instead of exploding
            StartOfRound.Instance.allPlayerScripts[playerId].DamagePlayer(40);
